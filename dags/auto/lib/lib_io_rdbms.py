...
def lib_class():
    return LibEnum.LibIoRdbms


def rdbms_write_table(cmp, object_prop, object_vars, rdbms_connector, df):
...
def rdbms_update_table(cmp, object_prop, object_vars, rdbms_connector):
...
def rdbms_truncate_table(cmp, object_prop, object_vars, rdbms_connector, df):
...
def rdbms_read_table(cmp, object_prop, object_vars, rdbms_connector):
...
def rdbms_delete_table(cmp, object_prop, object_vars, rdbms_connector, df):
...
def rdbms_delete_schema(cmp, object_prop, object_vars, rdbms_connector, df):
...
def rdbms_delete_database(cmp, object_prop, object_vars, rdbms_connector, df):
...
def rdbms_create_table(cmp, object_prop, object_vars, rdbms_connector, df):
...
def rdbms_write_prediction(cmp, object_prop, object_vars, rdbms_connector, df):
